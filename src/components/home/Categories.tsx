  ...
  return (
    <div className="hidden w-full items-center justify-center gap-x-4 rounded-lg border border-indigo-100 bg-indigo-50 px-5 py-3 dark:border-gray-800 dark:bg-primary-foreground md:flex">
      <div className="flex flex-1 flex-wrap items-center justify-between gap-2">
        <Link
          href="/posts"
          className="rounded-2xl bg-indigo-700 px-3 py-1.5 text-sm font-medium text-white"
        >
          All posts
        </Link>
        <Link
          href="/posts?cat=web-design"
          className="duration-400 rounded-2xl px-3 py-1.5 text-sm font-medium text-black transition hover:bg-indigo-50 dark:text-white"
        >
          Web Design
        </Link>
        <Link
